...
<div class="row">
            <div class="col">
                <h1 style="color: #555e81;text-align: center;"><b>驗證發文</b></h1>
            </div>
        ...
        <tbody>
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE numbered_post SET status='approved' WHERE post_id='$post_id'";
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {  
                        ...
                        echo "<button type='button' class='btn btn-success' onclick='confirmApprove(\"$post_id\")'><i class='fas fa-check'></i> 批准</button>";
                        echo "</form>";
                        echo "</td>";
                        echo "</tr>";
...
<script>
    ...
    function confirmApprove(post) {
        if (confirm("確定要批准這個文章嗎？")) {
            document.getElementById('approve_form_' + post).submit();
        }
    }
</script>
