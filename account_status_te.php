...
<div class="row">
            <div class="col">
                <h1 style="color: #555e81;text-align: center;"><b>房客帳號驗證</b></h1>
            </div>
        ...
        <tbody>
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE te_member SET status='approved' WHERE account='$account'";
