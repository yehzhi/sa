                    ...
                    <nav class="main_nav">
								<ul class="main_nav_list">
									...
									<li class="main_nav_item">
										<div class="dropdown">
											<a href="upload.html" role="button" data-bs-toggle="dropdown" aria-expanded="false">
												新增房屋
											</a>
											...
											<li class="main_nav_item">
												<a href="discuss.html" class="dropdown-toggle" data-toggle="dropdown"
													...
													<ul class="dropdown-menu" style="background-color: #a1a8c6;">
														<li style="background-color: #a1a8c6;"><a class="dropdown-item" href="discuss_num.html">有編號房屋</a></li>
														<li style="background-color: #a1a8c6;"><a class="dropdown-item" href="discuss_nonum.html">無編號房屋</a></li>
												</ul>
											</li>
