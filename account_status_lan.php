...
<div class="row">
            <div class="col">
                <h1 style="color: #555e81;text-align: center;"><b>房東帳號驗證</b></h1>
            </div>
        ...
        <tbody>
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE lan_member SET status='approved' WHERE account='$account'";
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {  
                        ...
                        echo "<td>";
                        echo "<form id='approve_form_$account' method='post'>";
                        echo "<input type='hidden' name='account' value='$account'>";
                        echo "<button type='button' class='btn btn-success' onclick='confirmApprove(\"$account\")'><i class='fas fa-check'></i> 批准</button>";
                        echo "</form>";
                        echo "</td>";
                        echo "</tr>";
...
<script>
    ...
    function confirmApprove(account) {
        if (confirm("確定要批准這個帳號嗎？")) {
            document.getElementById('approve_form_' + account).submit();
        }
    }
</script>
